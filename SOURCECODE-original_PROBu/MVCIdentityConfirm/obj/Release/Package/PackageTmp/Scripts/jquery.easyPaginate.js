    ...
    return this.each (function (instance) {        
        ...
        var displayNav = function() {
            ...
            if(plugin.settings.prevButton) {
                htmlNav += '<a href="" title="Poprzednia" rel="" class="prev">'+plugin.settings.prevButtonText+'</a>';
            }
            ...
            if(plugin.settings.nextButton) {
                htmlNav += '<a href="" title="Nastepna" rel="" class="next">'+plugin.settings.nextButtonText+'</a>';
            }
